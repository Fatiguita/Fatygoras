                 ...
                 <div className="flex items-center justify-between">
                     <div className="flex items-center gap-4">
                         ...
                         <div className="flex items-center gap-1">
                             ...
                             <button 
                                onClick={handleNext} 
                                disabled={currentIndex === slides.length - 1} // FIX: Ensure next button is disabled at last slide
                                className="p-2 text-white/70 hover:text-white hover:bg-white/10 rounded-lg transition disabled:opacity-30"
                 ...
                 <div className="absolute top-16 right-4 z-40 w-80 bg-slate-900/95 backdrop-blur border border-slate-700 rounded-xl shadow-2xl p-4 animate-fade-in text-left">
                     ...
                     <div className="space-y-4">
                         ...
                         <div>
                            ...
                            <input id="min-slide-time" type="range" min="1000" max="20000" step="1000" value={settings.minSlideDuration} onChange={(e) => setSettings({...settings, minSlideDuration: parseInt(e.target.value)})} className="w-full accent-indigo-500 h-1 bg-white/20 rounded-lg appearance-none cursor-pointer" />
                         </div>
                         <div>
